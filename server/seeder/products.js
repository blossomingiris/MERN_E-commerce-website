...
const products = [
  {
    ...
    category: 'Perfume',
    images: [
      { path: '/assets/perfume_category.png' },
      { path: '/assets/perfume_1' },
    ],
    rating: 5,
    reviewsNumber: 5,
    reviews: [],
    attrs: [{ key: 'volume', value: '50ml' }],
  },
  {
    name: 'Perfume2',
    description:
